...
- (BOOL)canBecomeBuildFile
{
    return _type == SourceCodeObjC || _type == SourceCodeObjCPlusPlus || _type == SourceCodeCPlusPlus || _type == XibFile || _type ==
        Framework || _type == ImageResourcePNG || _type == HTML || _type == Bundle || _type == Archive || _type == PropertyList;
}
...
- (XcodeMemberType)buildPhase
{
    ...
    else if (_type == ImageResourcePNG || _type == HTML || _type == Bundle || _type == PropertyList)
    {
